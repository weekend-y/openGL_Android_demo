...
void MyGLRenderContext::LoadLutImageData(int index, int format, int width, int height, uint8_t *pData)
{
	LOGCATE("MyGLRenderContext::LoadFilterImageData index=%d, format=%d, width=%d, height=%d, pData=%p",
